...
let imageRatio: CGFloat = 9.0 / 16.0
...
//        insertConfigurations()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.axu.RecipeCollection_Single" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("RecipeCollection_Single", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: "PSC", code: 9999, userInfo: dict)
    ...
    lazy var backgroundSaveManagedObjectContext: NSManagedObjectContext = {
...
extension AppDelegate {
    ...
    class func mergeIntoManagedObjectContext(context: NSManagedObjectContext, withNotification notification: NSNotification) {
